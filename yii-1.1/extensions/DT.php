...
class DT //DateTime
{
	...
	public static function testIso($d)
	{
		return self::testIsoDate($d);
	}
	
	public static function testIsoDate($d)
	{
		return (preg_match('/\d{4}-\d{2}-\d{2}/', $d));
	}
	
	public static function testIsoDateTime($d)
	{
		return (preg_match('/\d{4}-\d{2}-\d{2} \d{2}:\d{2}:\d{2}/', $d));
	}	
	...
	public static function toIsoDate($d = '')
	{
		...
		if (self::testIsoDate($d)) return $d;
	...
	public static function toIsoDateTime($d)
	{
		...
		if (self::testIsoDateTime($d)) return $d;
